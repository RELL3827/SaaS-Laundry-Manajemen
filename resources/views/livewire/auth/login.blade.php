...
<div class="min-h-[85vh] flex flex-col items-center justify-center p-4">
    ...
    <div class="max-w-md w-full bg-white rounded-2xl shadow-xl border border-slate-200/80 p-8 sm:p-10">
        ...
        <form wire:submit="login" class="space-y-4">
            ...
            <button type="submit" class="w-full py-3 px-4 rounded-xl shadow-md text-sm font-bold text-white bg-blue-600 hover:bg-blue-700 active:scale-95 transition-all flex items-center justify-center gap-2">
        ...
        <div class="mt-6 pt-6 border-t border-slate-100 text-center text-xs text-slate-500">
            ...
            <a href="/register" class="text-blue-600 font-bold hover:underline ml-1">Daftar Gratis 14 Hari</a>
        </div>
    </div>
</div>